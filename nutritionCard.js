...
exports.displayNutritionCards = function getNutritionData(foodName, session){
    var url = "https://api.nal.usda.gov/ndb/search/?format=json&q="+foodName+"&sort=r&max=1&offset=0&api_key=XKSltHbJuIHGVFToqcEUoCx1PvFbyEWzT1qfCba7";
...
function getFoodNutrition(message, foodName, session){
    ...
    var url = "https://api.nal.usda.gov/ndb/reports/?ndbno="+ndbno+"&type=f&format=json&api_key=XKSltHbJuIHGVFToqcEUoCx1PvFbyEWzT1qfCba7";
